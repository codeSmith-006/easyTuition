            ...
            <div className="hidden md:flex items-center space-x-8">
              {navItems.map((item, index) => (
                <motion.a
                  key={item.name}
                  href={item.href}
                  className="relative text-gray-800 dark:text-gray-200 hover:text-primary-yellow dark:hover:text-primary-teal font-medium cursor-pointer group"
                ...
                >
                  ...
                  />
                  <motion.span
                    className="absolute inset-0 bg-gradient-to-r from-primary-yellow/10 to-primary-teal/10 rounded-lg -z-10"
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center space-x-2">
              <GraduationCap className="w-6 h-6 text-primary-yellow dark:text-primary-teal" />
          ...
          <div className="flex-1 py-6 px-4 space-y-2">
            {navItems.map((item, index) => (
              <motion.a
                ...
                className="block relative px-4 py-3 rounded-lg text-gray-800 dark:text-gray-200 font-medium cursor-pointer group overflow-hidden border border-transparent hover:border-primary-teal"
              ...
              >
                ...
                />
                <motion.div
                  className="absolute inset-0 border border-transparent group-hover:border-primary-teal rounded-lg opacity-0 group-hover:opacity-100 shadow-[0_0_15px_rgba(13,148,136,0.3)]"
                  initial={{ scale: 0.8 }}
                  whileHover={{ scale: 1 }}
                  transition={{ duration: 0.3 }}
                />
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 p-6 space-y-4">
            {/* Theme Toggle */}
            <div className="flex items-center justify-between px-4 py-3 rounded-lg bg-white/50 dark:bg-primary-black/50 border border-primary-teal"
