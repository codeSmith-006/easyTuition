    ...
    <section id="cta" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          ...
          >
            <motion.button
              className="group relative px-12 py-5 bg-white text-blue-600 rounded-full font-bold text-lg shadow-2xl overflow-hidden"
            ...
            <motion.button
              className="px-12 py-5 bg-transparent border-2 border-white text-white rounded-full font-bold text-lg hover:bg-white hover:text-blue-600 transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Learn More
